...
import simpledb.buffer.LRUBufferMgr;
import simpledb.buffer.MidInsBufferMgr;
import simpledb.buffer.VanillaBufferMgr;
...
public class SimpleDB {
   ...
   /**
    * A constructor for **HW3**.
    * @param dirname the name of the database directory
    * @param blocksize the block size
    * @param buffsize the number of buffers
    * @param type the type of buffer manager
    */
   public SimpleDB(String dirname, int blocksize, int buffsize, String type) {
      ...
      /* This is for HW3-1*/
      if (type.equals("lru")){
         bm = new LRUBufferMgr(fm, lm, buffsize);
      }
      /* This is for HW3-2*/
      else if (type.equals("midIns")){
         bm = new MidInsBufferMgr(fm, lm, buffsize);
      }
      /* This is for HW3-1*/
      else {
         bm = new VanillaBufferMgr(fm, lm, buffsize);
      }
   ...
   public SimpleDB(String dirname) {
      this(dirname, BLOCK_SIZE, BUFFER_SIZE, TYPE);
